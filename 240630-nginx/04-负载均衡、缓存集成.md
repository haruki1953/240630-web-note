[Nginx_day04](资料/黑马nginx/day04/笔记/Nginx_day04.md)
...
![](assets/Pasted%20image%2020240708095457.png)
...
#### Nginx七层负载均衡的实现流程
![](assets/Pasted%20image%2020240708101902.png)
...
server{  
    location ~/purge(/.*) {  
        proxy_cache_purge 缓存名称“proxy_cache” 缓存key“proxy_cache_key”;  
    }  
}
```
访问 /purge/路径，清除缓存
![](assets/Pasted%20image%2020240709102057.png)
